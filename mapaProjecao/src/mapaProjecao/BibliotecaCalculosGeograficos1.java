...
public class BibliotecaCalculosGeograficos1 {
	...
	private static String MESSAGE = "Distância %s da classe BibliotecaCalculosGeograficos1";

	public float distanciaUTM(float x1, float x2, float y1, float y2){
		/**
		 * Calcula a distância entre dois pontos de coordenada UTM. Para simplificar
		 * os cálculos, considera-se sempre que as coordenadas estão sempre na mesma
		 * Zona. Do contrário os calculos seriam demasiadamente complexos.
		 */
